...
if($currentRoleAccess->read_access == "Y"){
    ...
    $aColumns = array( 'id_pages', 'title', 'seotitle', 'active', 'home');
    ...
    while ( $aRow = mysql_fetch_array( $rResult ) )
    {
        ...
        for ( $i=1 ; $i<count($aColumns) ; $i++ )
        {
            ...
            if($aRow['home'] == 'Y'){
                $home = "<i class='fa fa-eye-slash'></i> Set in Home";
            }else{
                $home = "<i class='fa fa-eye'></i> Not Set in Home";
            }
            ...
            $row[] = "<div class='text-center'>
                <div class='btn-group btn-group-xs'>
                    <a class='btn btn-xs btn-default sethome' id='$aRow[id_pages]' data-home='$aRow[home]'>$home</a>
                </div></div>";

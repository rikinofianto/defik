oTable = $('.dTableAjax').dataTable({
    ...
    "fnDrawCallback": function( oSettings ) {
        ...
        $(".sethome").click(function(){
            var id = $(this).attr("id");
            var headline = $(this).attr("data-home");
            if(headline == "Y"){
                var active = "N";
            }else{
                var active = "Y";
            ...
            var mod = 'pages';
            var act = 'homeact';
            var dataString = 'id='+ id + '&mod='+ mod + '&act='+ act + '&active='+ active;
            $("#"+id).html("Waiting...");
            $.ajax({
                type: "POST",
                ...
                success: function(){
                    if(headline == "Y"){
                        $("#"+id).attr("data-home","N");
                        $("#"+id).html("<i class='fa fa-eye'></i> Not Set in Home");
                    } else {
                        $("#"+id).attr("data-home","Y");
                        $("#"+id).html("<i class='fa fa-eye-slash'></i> Set in Home");
                    }
                }
            });
        });

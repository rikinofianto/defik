        ...
        <div class="table-responsive">
            <table class="table table-vcenter" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td><?=$langsetting27;?></td>
                    <td>
                        <div id="setting27" style="cursor:pointer;"><?=$currentSetting->website_subname;?></div>
                        <div class="form-group" id="settinginput27" style="display:none;">
                            <div class="input-group">
                                <input class="form-control" id="settingtext27" type="text" value="<?=$currentSetting->website_subname;?>">
                                <span class="input-group-btn">
                                    <button id="settingbtn27" class="btn btn-primary" type="button"><i class="fa fa-check"></i> <?=$langsetting11;?></button>
                                </span>
                            </div>
                        </div>
                    </td>

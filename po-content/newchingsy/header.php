        ...
        <div class="header_top_bar_container clearfix">
            <div class="header_top_bar">
                <form class="search" method="post" action="<?=$website_url;?>/search-result/">
                    <input type="text" name="search" placeholder="Search..." class="search_input hint">
                ...
                <div class="latest_news_scrolling_list_container">
                    <ul>
                        ...
                        <li class="posts">
                            ...
                            ?>
                                <li><a href="<?php echo "$website_url/category/$currentCatrec->seotitle"; ?>" title="<?=$rec->title;?>"><?=$rec->title;?></a></li>
                            <?php
                                endforeach;
                            ?>
                            </ul>
